    ...
    <div class="divcontainer">
        ...
        <div class="contentscreen">
            ...
            <div class="contentdivscreen">
                ...
                <div class="prenpass"><button class="btn btn-outline-secondary showqrcodebutton" type="button" disabled=""><i class="fa fa-qrcode"></i></button><span class="prentitle"><strong>Pass for 4 people</strong></span><span class="prenparag">Valid from 02/09/2020 to 02/10/2020</span>
                    <span
                        class="validlabel" style="color: red;">EXPIRIED</span>
                </div>
                <hr>
                <div class="prenpass"><button class="btn btn-primary showqrcodebutton" type="button"><i class="fa fa-qrcode"></i></button><span class="prentitle">01/10/2020 for 4 people</span><span class="prenparag">Time slot: 15:00 - 20:00</span></div>
            </div>
            <hr>
            <div class="buttoncontainer"><button class="btn btn-primary" type="button">Buy a pass</button><button class="btn btn-primary" type="button">Book a place</button></div>
        </div>
    </div>
